    ...
    override fun createChartPanels(viewport: ChartViewport): MutableList<ChartPanel> {
        return mutableListOf(
            ChartPanel(viewport).apply {
                ...
                addAxis(
                    YAxis(AxisSide.LEFT, AxisPosition.OUTSIDE, 100F).apply {
                        addLabels(
                            AxisLabel(0f),
                            AxisLabel(0.25F),
                            AxisLabel(0.5F),
                        ...
                        formatter = object : YAxisLabelFormatter(xRenderers) {
                    ...
                    XAxis(AxisSide.BOTTOM, AxisPosition.OUTSIDE, 56F).apply {
                        ...
                        formatter = object : XAxisLabelFormatter(xRenderers) {
